...
public class GuiOptions extends GuiScreen {
  ...
  public void initGui() {
    ...
    if (this.mc.world != null) {
      ...
      this.difficultyButton = new GuiButton(108, this.width / 2 - 155 + i % 2 * 160, this.height / 6 - 12 + 24 * (i >> 1), 150, 20, getDifficultyText(enumdifficulty));
    ...
    this.buttonList.add(new GuiButton(110, this.width / 2 - 155, this.height / 6 + 48 - 6, 150, 20, I18n.format("fml.menu.mods", new Object[0])));
  ...
  public String getDifficultyText(EnumDifficulty p_175355_1_) {
    ...
    textComponentString.appendSibling((ITextComponent)new TextComponentTranslation("options.difficulty", new Object[0]));
    textComponentString.appendText(": ");
    textComponentString.appendSibling((ITextComponent)new TextComponentTranslation(p_175355_1_.getDifficultyResourceKey(), new Object[0]));
    return textComponentString.getFormattedText();
  }
  ...
  protected void actionPerformed(GuiButton button) throws IOException {
    if (button.enabled) {
      ...
      if (button.id == 108) {
        ...
        this.difficultyButton.displayString = getDifficultyText(this.mc.world.getDifficulty());
      } 
      if (button.id == 109)
